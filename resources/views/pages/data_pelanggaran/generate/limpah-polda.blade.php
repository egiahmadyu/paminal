...
<body style="font-size:14px;font-weight: bold">
    <table style="width: 60%;font-size: 16px;font-weight: bold;text-align: center">
        ...
        <tr>
            <td>DIVISI PROFESI DAN PENGAMANAN</td>
        </tr>
        <tr>
            <td>Jalan Trunojoyo 3 Kebayoran Baru, Jakarta 12110</td>
        </tr>
        <tr>
            <td>
                <hr>
    ...
    <table>
        <tr>
            <td>Nomor</td>
            <td>:</td>
            <td width="60%">R/...../XII/WAS2.4/2022/Divropam</td>
        ...
        <tr>
            <td>Perihal</td>
            <td>:</td>
            <td>Pelimpahan Penanganan Dumas</td>
        </tr>
    </table>
    <div style="height:90px">
        <table style="float: right;position: absolute;">
            ...
            <tr>
                <td>Yth. KOMANDAN KORPS BRIMOB POLRI</td>
            </tr>
            <tr>
                <td>di</td>
            </tr>
