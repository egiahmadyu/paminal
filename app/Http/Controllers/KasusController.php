...
class KasusController extends Controller
{
    ...
    private function viewGelarPenyelidikan($id)
    {
        ...
        $data = [
            ...
            'usia_dumas' => $usia_dumas . ' hari',
            'terlapor' => $pangkat_terlapor->name . ' ' . $kasus->terlapor,
            'tgl_bai_pelapor' => $bai_pelapor->created_at ? Carbon::parse($bai_pelapor->created_at)->translatedFormat('d F Y') : '',
            'tgl_bai_terlapor' => $bai_terlapor->created_at ? Carbon::parse($bai_terlapor->created_at)->translatedFormat('d F Y') : '',
